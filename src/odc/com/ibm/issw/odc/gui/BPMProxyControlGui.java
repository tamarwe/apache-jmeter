...
public class BPMProxyControlGui extends LogicControllerGui implements JMeterGUIComponent, ActionListener, ItemListener,
    ...
    protected ProxyControl makeProxyControl() {
        ProxyControl local = new BPMProxyControl();
        return local;
    }
    ...
    public String getLabelResource() {
        return "odc_proxy_title"; // $NON-NLS-1$
    }
